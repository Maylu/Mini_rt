...
/*   Updated: 2026/09/03 21:54:51 by rhmontei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_test(t_world *w)
{
	...
	printf("  Position : x = %f, y = %f, z = %f\n", w->form[1]->vec3.x,
		w->form[1]->vec3.y, w->form[1]->vec3.z);
	printf("  Color    : r = %f, g = %f, b = %f\n", w->form[1]->color.r,
		w->form[1]->color.g, w->form[1]->color.b);
	printf("Plane:\n");
	printf("  Position : x = %f, y = %f, z = %f\n", w->form[0]->vec3.x,
		w->form[0]->vec3.y, w->form[0]->vec3.z);
	printf("  Norm : x = %f, y = %f, z = %f\n", w->form[0]->norm.x,
		w->form[0]->norm.y, w->form[0]->norm.z);
	printf("  Color    : r = %f, g = %f, b = %f\n", w->form[0]->color.r,
		w->form[0]->color.g, w->form[0]->color.b);

	printf("Ambiant light:\n");
	printf("  Ratio : %f\n", w->ambient->lighting);
	printf("  Color    : r = %f, g = %f, b = %f\n", w->ambient->color.r,
		w->ambient->color.g, w->ambient->color.b);
